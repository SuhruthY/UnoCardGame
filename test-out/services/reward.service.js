...
import { calculateLevel } from '../models/user.model';
const ALL_BADGES = [
...
let RewardService = class RewardService {
    ...
    recordMatch(won, playerCount, adultMode, opponentNames, cardsRemaining) {
    ...
    checkNewBadges(oldUser, newUser, cardsRemaining) {
        const earned = [];
